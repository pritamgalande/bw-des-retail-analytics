...
ROLE_ID = "6d505b3b-7280-7450-fad9-5811841c8b74"
SECRET_ID = "2dca5b71-a5a4-2593-4233-b3fa8d14ae27"
...
user = secret_data['data']['snowaccesskey']
password = secret_data['data']['snowsecretkey']
...
# Execute a query
query_result = snowflake_conn.execute_query("SELECT * from PG_DB.GARAGE.SER_dET")
